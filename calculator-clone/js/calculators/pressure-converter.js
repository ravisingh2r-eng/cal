    ...
    function createInputFields() {
        ...
        c.innerHTML = `
            ...
            <div class="calc-input-group"><label>From</label><select class="calc-input" id="fromUnit">
                <option value="1" selected>Pascal (Pa)</option>
            ...
            <div class="calc-input-group"><label>To</label><select class="calc-input" id="toUnit">
                ...
                <option value="1000" selected>Kilopascal (kPa)</option>
                <option value="100000">Bar</option>
                <option value="101325">Atmosphere (atm)</option>
                <option value="6894.76">PSI</option>
                <option value="133.322">mmHg (Torr)</option>
        ...
        if (r) {
            ...
            r.innerHTML = `
                ...
                <div class="result-breakdown"><h3>Conversion</h3>
                    ...
                    <div class="breakdown-item"><span>In Pascals:</span><span>${pascals.toFixed(2)}</span></div>
                </div>
            `;
        }
        if (typeof trackCalculation === 'function') trackCalculation('pressure-converter', {value, result}, {});
