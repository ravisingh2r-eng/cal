/**
 * Minimum Payment Calculator Calculator
...
(function() {
    ...
    function calculate() {
        ...
        if (typeof trackCalculation === 'function') {
            trackCalculation('minimum-payment', { premium: true }, { value: 'high-cpc' });
        }
    ...
    function loadAffiliateOffers() {
        ...
        console.log('Loading affiliate offers for minimum-payment');
    }
