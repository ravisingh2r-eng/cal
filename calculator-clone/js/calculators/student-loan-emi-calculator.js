/**
 * Student Loan Emi Calculator Calculator
...
(function() {
    ...
    function calculate() {
        ...
        if (typeof trackCalculation === 'function') {
            trackCalculation('student-loan-emi', { premium: true }, { value: 'high-cpc' });
        }
    ...
    function loadAffiliateOffers() {
        ...
        console.log('Loading affiliate offers for student-loan-emi');
    }
