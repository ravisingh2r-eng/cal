    ...
    function createInputFields() {
        ...
        c.innerHTML = `
            ...
            <div class="calc-input-group"><label>From</label><select class="calc-input" id="fromUnit">
                <option value="1" selected>Liter (L)</option>
                <option value="1000">Milliliter (mL)</option>
                <option value="0.001">Cubic Meter (m³)</option>
                <option value="1000000">Cubic Centimeter (cm³)</option>
                <option value="0.264172">Gallon (US)</option>
                <option value="0.219969">Gallon (UK)</option>
                <option value="33.814">Fluid Ounce (US)</option>
                <option value="4.22675">Cup (US)</option>
            </select></div>
            <div class="calc-input-group"><label>To</label><select class="calc-input" id="toUnit">
                <option value="1">Liter (L)</option>
                <option value="1000" selected>Milliliter (mL)</option>
                <option value="0.001">Cubic Meter (m³)</option>
                <option value="1000000">Cubic Centimeter (cm³)</option>
                <option value="0.264172">Gallon (US)</option>
                <option value="0.219969">Gallon (UK)</option>
        ...
        if (r) {
            ...
            r.innerHTML = `
                ...
                <div class="result-breakdown"><h3>Conversion</h3>
                    ...
                    <div class="breakdown-item"><span>In Liters:</span><span>${liters.toFixed(6)}</span></div>
                </div>
            `;
        }
        if (typeof trackCalculation === 'function') trackCalculation('volume-converter', {value, result}, {});
