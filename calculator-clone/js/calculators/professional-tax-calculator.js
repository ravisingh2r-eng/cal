/**
 * Professional Tax Calculator Calculator
...
(function() {
    ...
    function calculate() {
        ...
        if (typeof trackCalculation === 'function') {
            trackCalculation('professional-tax', { premium: true }, { value: 'high-cpc' });
        }
    ...
    function loadAffiliateOffers() {
        ...
        console.log('Loading affiliate offers for professional-tax');
    }
